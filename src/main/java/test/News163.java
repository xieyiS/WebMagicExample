...
public class News163 implements MultiPageModel {
    ...
    public static void main(String[] args) {
        ...
        OOSpider ooSpider = OOSpider.create(Site.me().setSleepTime(0)/*.setCharset("UTF-8")*/, News163.class);
        String url = "http://news.163.com/13/0802/05/958I1E330001124J_2.html";
        //single download
        News163 news163 = ooSpider.<News163>get(url);
        System.out.println(news163);
